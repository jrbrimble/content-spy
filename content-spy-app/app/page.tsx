...
import { getAllCompetitorsWithPosts } from '@/lib/data'
import { CompetitorWithPosts, ViewMode } from '@/lib/types'
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        <div className="mb-8">
          <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-6">
            <div className="flex-1">
              <div className="flex items-center gap-3 mb-2">
                <div className="w-9 h-9 rounded-xl overflow-hidden shrink-0">
                  <img src="/logo.webp" alt="Content Spy" className="w-full h-full object-cover" />
                </div>
                <h1 className="text-2xl font-bold text-white tracking-tight">Content Spy</h1>
              </div>
            ...
            {/* Right side: Start Spying button + View Toggle */}
          ...
          {scrapeMessage && (
            <div className="mt-4 flex items-center gap-2.5 bg-violet-500/10 border border-violet-500/30 rounded-xl px-4 py-3">
              {scraping && (
          ...
          {scrapeError && (
            <div className="mt-4 flex items-center gap-2.5 bg-red-500/10 border border-red-500/30 rounded-xl px-4 py-3">
        ...
        {!loading && !error && competitors.length === 0 && (
          <div className="text-center py-32">
            ...
            <p className="text-slate-500 text-sm mt-1 mb-6">Press "Start Spying" above to fetch the latest competitor content.</p>
            <button
              onClick={handleStartSpy}
              disabled={scraping}
