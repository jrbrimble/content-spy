...
import { CompetitorWithPosts, ViewMode, CompetitorInput, DashboardTab } from '@/lib/types'
import ViewToggle from '@/components/ViewToggle'
import CompetitorView from '@/components/CompetitorView'
import PlatformView from '@/components/PlatformView'
import CompetitorModal from '@/components/CompetitorModal'
import DeleteConfirmModal from '@/components/DeleteConfirmModal'
import ViralFinderView from '@/components/ViralFinderView'

export default function DashboardPage() {
  const [activeTab, setActiveTab] = useState<DashboardTab>('competitors')
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-5">
          <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-4">
              ...
              {/* Mode Switcher */}
              <div className="flex items-center gap-1.5 bg-slate-950 p-1.5 rounded-2xl border border-slate-800/80 shadow-inner">
                <button
            ...
            {/* Right side: Competitor Actions & View Toggle (only in Competitors Mode) */}
            {activeTab === 'competitors' && (
