...
export async function getViralPosts(niche: string = 'AI Agents'): Promise<import('./types').ViralPost[]> {
  ...
  const rawPosts: import('./types').ViralPost[] = [
    // --- TIKTOK (Top 5) ---
    {
      ...
      caption: `How to build an autonomous ${niche} workflow that scales revenue without extra hiring 🤖🚀`,
    ...
    },
    {
      ...
      caption: `Stop wasting time! These 3 ${niche} AI agent strategies build full-stack web apps in 10 mins 💻💥`,
